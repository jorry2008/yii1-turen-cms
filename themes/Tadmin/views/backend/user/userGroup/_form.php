...
$form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group clearfix">
		...
		<div class="col-md-10">
			...
			<div class="col-md-7">
				<span class="help-block"><?php echo $form->error($model,'parent_id'); ?></span>
			</div>
		</div>
	</div>
	...
	<div class="form-group clearfix">
		...
		<div class="col-md-10">
			<div class="col-md-7">
				<?php //没有管理员权限，按钮应该不可用?>
				<?php echo $form->dropDownList($model,'role',Yii::app()->authManager->getAuthItemsForSelects(CAuthItem::TYPE_ROLE),array('class'=>'form-control col-md-5','placeholder'=>Yii::t('common', 'Enter..'))); ?>
			</div>
			<div class="col-md-3">
				<?php echo CHtml::link(Yii::t('common', 'Edit'), array('/backend/auth/role/admin'), array('target'=>'_blank', 'class'=>'btn btn-sm btn-primary'));?>
			</div>
			<div class="col-md-7">
	...
	<div class="form-group clearfix">
		...
		<div class="col-md-10">
			...
			<div class="col-md-7">
				<span class="help-block"><?php echo $form->error($model,'sort'); ?></span>
			</div>
		</div>
	</div>
